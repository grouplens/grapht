...
public class DependencySolver {
     ...
     * @return
     */
    public DAGNode<CachedSatisfaction,DesireChain> rewrite(DAGNode<CachedSatisfaction,DesireChain> graph) throws SolverException {
        // We proceed in three stages.
        Map<DAGEdge<CachedSatisfaction,DesireChain>,DAGNode<CachedSatisfaction,DesireChain>> replacementSubtrees =
                Maps.newHashMap();
